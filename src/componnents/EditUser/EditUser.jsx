...
function EditUser({ oldUser }) {
	const { UpdateProfile } = useContext(ProfilesContext)
	...
	useEffect(() => {
		ChooseCity()
		setIsLoggedIn(CheckIfCurrentUser())
		// if (!isLoggedIn) {
		// 	route('/login')
		// }
	}, [])
	...
	const handleUpdate = (event, user) => {
		UpdateProfile(event, user, oldUser)
	...
	return (
		<div className='register-container '>
			<fieldset className='register-fieldset'>
				<legend className='register-fieldset-legend'>Edit User: </legend>
				<form
					className='register-form'
					onSubmit={event => handleUpdate(event, user)}
				>
